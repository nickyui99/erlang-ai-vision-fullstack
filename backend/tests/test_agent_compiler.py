...
os.environ["DATABASE_URL"] = f"sqlite+aiosqlite:///{(Path(tempfile.gettempdir()) / 'sentineledge_compiler_pytest.db').as_posix()}"
...
def _client() -> TestClient:
    ...
    client.cookies.set("sentineledge_session", create_session_token("usr_c"))
    return client
